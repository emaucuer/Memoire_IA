...
# -----------------------------------------------------------------------------#
data26 <- read_rds("../Data/indic_aladin_2022_2050_RCP26.rds") 
data45 <- read_rds("../Data/indic_aladin_2022_2050_RCP45.rds")
data85 <- read_rds("../Data/indic_aladin_2022_2050_RCP85.rds")


#dataA1B <- read_rds("../Data/indic_climsec_2000_2050_A1B.rds") 
dataA2 <- read_rds("../Data/indic_climsec_2000_2050_A2.rds") 
dataB1 <- read_rds("../Data/indic_climsec_2000_2050_B1.rds") 
dataA2_new <- read_rds("../Data/indic_climsec_2020_2050_A2_new.rds") 
dataB1_new <- read_rds("../Data/indic_climsec_2020_2050_B1_new.rds") 
...
infos_com <- read_rds("../Data/infos_communes.rds")
